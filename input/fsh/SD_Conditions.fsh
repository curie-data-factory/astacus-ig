Profile: AstacusPrimaryCancerCondition
Id: astacus-primary-cancer-condition
Title: "French Primary Cancer Condition Profile"
Parent: Condition
...
Profile: AstacusSecondaryCancerCondition
Parent: Condition
Id: astacus-secondary-cancer-condition
Title: "French Secondary Cancer Condition Profile"
...
* extension[relatedPrimaryCancerCondition].value[x] only Reference(AstacusPrimaryCancerCondition)
